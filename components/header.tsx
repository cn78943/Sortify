    ...
    <header className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center h-16">
        ...
        <nav className="space-x-4 md:block">
          <a href="/todos" className="hover:text-violet-700">일정 확인/편집</a>
          <a href="/teams" className="hover:text-violet-700">협업 메뉴</a>

          {!isLoggedIn ? (
            <>
              <a href="/login" className="px-4 py-2 bg-slate-500 text-white rounded-lg hover:bg-slate-800">로그인</a>
              <a href="/signup" className="px-4 py-2 bg-violet-400 text-white rounded-lg hover:bg-violet-700">회원가입</a>
            </>
          ) : (
            <button
